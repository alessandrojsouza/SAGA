    ...
    setInterval(    //Loop de 0,5 segundo
        function() { 
            ...
            if (estadoBomba == "1" && estadoValvulaSubida == "1" && nivelCisterna <= 50 && porcentagemCisterna <= 100) {
                $.get("recebevazao.php?vazaoSubida=1", function(vazao) { //Chama a função quando a requisição for carregada
    ...
    setInterval(    //Loop de 0,5 segundo
        function() { 
            ...
            if (estadoValvulaDescida == "1" && nivelPoço <= 50 && porcentagemPoço <= 100) {
                $.get("recebevazao.php?vazaoDescida=1", function(vazao) { //Chama a função quando a requisição for carregada
...
function realTime() {
    ...
    $.get("recebevalores.php", function(estados) {     //Ao carregar a requisição...
